...
export default function ObraExteriorPage() {
  ...
  if (!proyecto) {
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center">
        ...
        <Link href="/proyectos/exteriores" className="text-blue-600 underline">Volver</Link>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center py-12 px-4">
      <div className="w-full max-w-2xl mx-auto mb-8">
        <Link href="/proyectos/exteriores" className="flex items-center gap-2 text-black font-semibold mb-6">
